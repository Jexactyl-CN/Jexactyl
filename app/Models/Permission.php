...
class Permission extends Model
{
    ...
    protected static $permissions = [
        ...
        'plugin' => [
            'description' => '控制用户查看和安装 Spigot 插件的权限。',
            'keys' => [
                'read' => '允许用户查看 Spigot 插件。',
                'download' => '允许用户下载 Spigot 插件。',
            ],
        ],
        ...
        'backup' => [
            ...
            'keys' => [
                ...
                'restore' => '允许用户恢复服务器的备份。这是个危险权限：这允许用户删除服务器中的所有服务器文件。',
            ],
        ],
